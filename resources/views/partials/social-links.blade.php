<div class="buttons-social-media-share">
    <ul class="share-buttons">
        ...
        <li>
            <a href="https://twitter.com/intent/tweet?url={{ request()->fullUrl() }}&text={{ $description }}&via={{ config('app.name') }}&hashtags=zendero"
               target="_blank"
               title="Tweet"
            >
        ...
        <li>
            <a href="http://pinterest.com/pin/create/button/?url={{ request()->fullUrl() }}&title={{ $description }}"
               target="_blank"
               title="Pin it"
            >
