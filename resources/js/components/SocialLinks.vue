<template>
	<div class="buttons-social-media-share">
	    <ul class="share-buttons">
	        ...
	        <li>
	            <a :href="`https://twitter.com/intent/tweet?url=${url}&text=${description}&via=Ducke&hashtags=zendero`"
	               target="_blank"
	               title="Tweet"
	            >
	        ...
	        <li>
	            <a :href="`http://pinterest.com/pin/create/button/?url=${url}&title=${description}`"
	               target="_blank"
	               title="Pin it"
	            >
